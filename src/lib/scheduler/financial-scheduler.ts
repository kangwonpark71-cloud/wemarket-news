...
const defaultConfig: FinancialSchedulerConfig = {
  ...
  metricsEnabled: true,
  maxConcurrentJobs: 1,
  stockPriceInterval: 10 * 60 * 1000,
  cryptoTickerInterval: 5 * 60 * 1000,
  forexInterval: 60 * 60 * 1000,
  globalIndexInterval: 60 * 60 * 1000,
  stockMasterSyncCron: '0 1 * * *',
  cryptoMarketSyncCron: '0 2 * * *',
  initialDelay: 10000,
  lockTimeout: 600,
}
